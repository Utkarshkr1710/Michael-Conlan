    ...
    <Carousel style={{ width: '100%', height: 300 }}>
      <Image
       ...
       <Image
        ...
        source= {{uri: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR1aSBpq2L6B0P-oKEYFxqF7XvLWVxy2HMYwgxI82A0VQYsiTvB'}}     />
      ...
      <ScrollView style={{ flex: 1, backgroundColor: "#000" }}>
        <SafeAreaView style={{ flex: 1, backgroundColor: "#000" }}>
          ...
          >
            ...
            {[1, 2, 3, 4, 4, 5, 6, 7, 6, 7].map((item, i) => (
              <View key={i} style={{ padding: 4 }}>
                <Lightbox
                  style={{}}
                  willClose={() =>
                    this.setState({ imgHeight: 110, imgWidth: 110 })
                  }
                  onOpen={() =>
                    this.setState({ imgHeight: 300, imgWidth: "100%" })
                  }
                  swipeToDismiss={true}
